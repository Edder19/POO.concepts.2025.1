...
namespace POOconcepts
{
    public class CommisionEmployee : Employee
    {
        ...
        public CommisionEmployee(int id, string firstName, string lastName, Date? hireDate, Date? bornDate, bool isActive, float commisionPercentaje, decimal sales) : base(id, firstName, lastName, hireDate, bornDate, isActive)
        {
        ...
        public override string ToString()
        {
            return
                $"{base.ToString()}\n\t"  
              +$"Commision %....:"  + $"{_commisionPercentaje,20:P2}\n\t" 
               + $"Sales..........:"  + $"{_sales,20:C2}\n\t" 
